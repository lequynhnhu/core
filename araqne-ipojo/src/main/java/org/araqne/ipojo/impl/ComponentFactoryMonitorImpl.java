...
import org.araqne.ipojo.ComponentFactoryTracker;
import org.araqne.ipojo.ComponentFactoryMonitor;
...
public class ComponentFactoryMonitorImpl extends ServiceTracker implements ComponentFactoryMonitor {
	...
	public void start() {
		...
		try {
			...
			logger.error("araqne ipojo: invalid factory filter", e);
		}
	}
	...
	private void checkRequirements() {
		for (ComponentFactoryTracker ready : trackers) {
			try {
				...
				logger.warn("araqne ipojo: callback should not throw any exception", e);
			}
		}
	}

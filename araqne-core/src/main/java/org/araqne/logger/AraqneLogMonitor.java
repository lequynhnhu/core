...
import org.slf4j.impl.AraqneLog;
import org.slf4j.impl.AraqneLoggerFactory;

public class AraqneLogMonitor implements Runnable {
	private ScriptContext context;
	private AraqneLoggerFactory loggerFactory;
	private SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");

	public AraqneLogMonitor(ScriptContext context, AraqneLoggerFactory loggerFactory) {

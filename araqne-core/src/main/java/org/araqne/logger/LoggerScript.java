...
public class LoggerScript implements Script {
	...
	public LoggerScript() {
		this.loggerFactory = (AraqneLoggerFactory) StaticLoggerBinder.getSingleton().getLoggerFactory();
	}
	...
	public void tail(String[] args) throws InterruptedException {
		AraqneLogMonitor monitor = new AraqneLogMonitor(context, loggerFactory);

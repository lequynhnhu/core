...
import org.araqne.api.PackageMetadata;
...
import org.araqne.api.VersionRange;
...
public class PackageScript implements Script {
	...
	@ScriptUsage(description = "add package repository", arguments = {
			@ScriptArgument(name = "alias", type = "string", description = "the alias of araqne package repository"),
			@ScriptArgument(name = "url", type = "string", description = "the url of araqne package repository") })
	...
	@ScriptUsage(description = "add secure package repository", arguments = {
			@ScriptArgument(name = "alias", type = "string", description = "the alias of araqne package repository"),
			@ScriptArgument(name = "url", type = "string", description = "the url of araqne package repository"),
			@ScriptArgument(name = "trust store alias", type = "string", description = "the alias of araqne truststore"),
			@ScriptArgument(name = "key store alias", type = "string", description = "the alias of araqne keystore. if provided, client authentication will be used", optional = true) })
	...
	@ScriptUsage(description = "remove package repository", arguments = { @ScriptArgument(name = "alias", type = "string", description = "the alias of araqne package repository") })
	...
	public void install(String[] args) {
		...
		try {
			...
			logger.error("araqne core: already installed package [{}]", packageName);
		} catch (PackageNotFoundException e) {
			context.println("Package not found.");
			logger.error("araqne core: package [{}] not found", packageName);
		} catch (MavenResolveException e) {
			context.println("Maven resolver failed: " + e.getMessage());
			logger.error("araqne core: resolver failed", e);
		} catch (UnrecoverableKeyException e) {
			logger.error("araqne core: unrecoverable key", e);
		} catch (KeyManagementException e) {
			logger.error("araqne core: key management error", e);
		} catch (KeyStoreException e) {
			logger.error("araqne core: key store error", e);
		} catch (RuntimeException e) {
			if (e.getCause() instanceof BundleException) {
				context.println("Bundle exception: " + e.getMessage());
				logger.error("araqne core: bundle error", e);
			} else {
				context.println("unknown error: " + e.getMessage());
				logger.error("araqne core: unknown error", e);
			}
		}
	}

	@ScriptUsage(description = "update bundles and install missing bundles", arguments = { @ScriptArgument(name = "package name", type = "string", description = "the name of araqne package") })
	...
	@ScriptUsage(description = "check version and update package", arguments = { @ScriptArgument(name = "package name", type = "string", description = "the name of araqne package") })
	...
	@ScriptUsage(description = "uninstall package", arguments = { @ScriptArgument(name = "package name", type = "string", description = "the name of araqne package") })

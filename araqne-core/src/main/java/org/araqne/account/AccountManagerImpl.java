...
public class AccountManagerImpl implements AccountManager, AuthProvider {
	private static final String SALT = "araqne";
	...
	public void createAccount(String name, String password) {
		...
		try {
			...
			xact.commit("araqne-core", "created account: " + name);
		} catch (Throwable e) {
			xact.rollback();
		}
	}
	...
	public void removeAccount(String name) {
		...
		try {
			...
			db.remove(c2);
			xact.commit("araqne-core", "removed account: " + name);
		} catch (Throwable e) {
			xact.rollback();
		}
	}
	...
	public void changePassword(String name, String currentPassword, String newPassword) {
		...
		c.setDocument(m);
		credentials.update(c, false, "araqne-core", "changed password for " + name);
	}
